// import { Playlist, Settings, Song } from './types/tawa'

export const HERE_FOR_DOCUMENTATION = ''
...
//  */
// export const shuffleRandomWithoutEvents = (playlist: Playlist): Song[] => {
...
//  */
// // export const modernShuffle = (p: Playlist): Song[] => {
// //   let playlist = p
...
// //     const songs = playlist.songs!.filter(song => song.added_by.username === selectedUser)
...
// //     songs.forEach(song => {
// //       const artist = song.artists || 'Kokopelli::unknown'
...
// //     const selectedArtist = Array.from(groupedSongs.keys())[0]
// //     const lowestPlayCount = 0
...
//  */
// export const shuffleWeightedSong = (playlist: Playlist, length?: number): Song[] => {
//   const songs = playlist.songs!
//   const shuffled = weightedSongShuffle(playlist.id, songs)
//   return shuffled.slice(0, length ?? SHUFFLE_LENGTH)
// }
 
// const resetPlayCount = (playlistId: number, songs: Song[]): Song[] => {
...
// export const shuffleWeightedSongWithEvents = (playlist: Playlist, settings: Settings): PlayerEvent[] => {
//   const queue: PlayerEvent[] = shuffleWeightedSong(playlist, settings.event_frequency)
...
//  */
// const weightedSongShuffle = (playlistId: number, playlist: Song[]): Song[] => {
//   const queue: Song[] = []
